...
class SupabaseGarmentRepository implements GarmentRepository {
  final SupabaseClient _supabase;
  final String _table = 'garments';

  SupabaseGarmentRepository({SupabaseClient? supabase}) : _supabase = supabase ?? Supabase.instance.client;
