...
///
/// Handles admin operations including user management, analytics,
/// platform monitoring, and administrative controls using Supabase PostgreSQL
class AdminRepositoryImpl implements AdminRepository {
  ...
  Future<Map<String, dynamic>> exportAdminData(String adminId) async {
    try {
      final admin = await getAdmin(adminId);
      if (admin == null) {
        throw AdminRepositoryException('Admin not found for export');
      }
