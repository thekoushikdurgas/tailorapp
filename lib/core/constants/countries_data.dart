...
class CountriesData {
  static const List<Map<String, String>> _countriesRaw = [
  ...
  static List<CountryModel> get countries {
    return _countriesRaw
        .map((country) => CountryModel.fromMap(country))
        .toList();
  }

  static List<CountryModel> get popularCountries {
    final popularCodes = [
      '+1',
      '+91',
      '+44',
    ...
    return countries
        .where((country) => popularCodes.contains(country.code))
        .toList();
  }
  ...
  static CountryModel? findByName(String name) {
    try {
  ...
  static List<CountryModel> searchCountries(String query) {
    ...
    return countries.where((country) {
      return country.name.toLowerCase().contains(lowerQuery) ||
          country.code.toLowerCase().contains(lowerQuery.replaceAll('+', ''));
    }).toList();
  }

  static CountryModel get defaultCountry => const CountryModel(
        name: 'India',
        code: '+91',
        flag: '🇮🇳',
      );
