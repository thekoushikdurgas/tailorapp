...
class _UserCreationModalState extends State<UserCreationModal> {
  ...
  void _createAccount() async {
    ...
    try {
      // Create user with UserDataCubit
      ...
      await context.read<UserDataCubit>().createUser(userModel);

      // Check if user creation was successful and navigate
      if (mounted) {
        ...
        if (userState is UserDataLoaded) {
          ...
          context.go(userState.user.role.homeRoute);
        }
      }
    } catch (e) {
      if (mounted) {
