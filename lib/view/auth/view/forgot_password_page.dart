  ...
  Widget _buildRequestContent(bool isLoading) {
    return Column(
      ...
      children: [
        ...
        Text(
          'No worries! Enter your email address and we\'ll send you a link to reset your PIN.',
          style: TextStyle(
            fontSize: 16,
  ...
  void _handleSendResetEmail() async {
    if (_formKey.currentState?.validate() ?? false) {
      try {
        ...
        await context.read<AuthCubit>().sendPinResetEmail(emailText);
        ...
        if (mounted) {
          ...
          scaffoldMessenger.showSnackBar(
            SnackBar(
              content: Text('PIN reset link sent to $emailText'),
